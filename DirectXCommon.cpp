...
void DirectXCommon::Initialize(WinApp* winApp)
{
    ...
    InitilizeSwapchain();
    //レンダーターゲットビュー
    InitilizeRenderTargetView();
    //深度バッファ
    InitilizeDepthBuffer();
    //フェンス
    InitilizeFence();
...
void DirectXCommon::InitilizeCommand()
{
...
void DirectXCommon::InitilizeSwapchain()
{
    HRESULT result;
...
void DirectXCommon::InitilizeRenderTargetView()
{
    HRESULT result;
...
void DirectXCommon::InitilizeDepthBuffer()
{
    HRESULT result;
    // リソース設定
...
void DirectXCommon::InitilizeFence()
{
    HRESULT result;
